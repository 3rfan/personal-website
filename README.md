...
A minimal, responsive and modern personal portfolio website, tailored for Engineers
...
- **TypeScript**: The proper version of JavaScript
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/3rfan/personal-website.git
   ```
...
This project is inspired by 2 other amazing portfolios:

- [Gianmarco Portfolio](https://gianmarco.xyz/)
- [bue221 Portfolio](https://portafolio.bue221.xyz/)
